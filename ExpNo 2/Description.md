...
v,e = map(int,input("Enter the no.of Vertex and Edges: ").split())
for i in range(e):
...
![image](https://github.com/ShafeeqAhamedS/Fundamentalsof_AI/assets/93427237/e3fa2019-1141-4022-b511-13b71f9fee21)
<hr>
